#' @title mychisim
#' @description Create plot of Chi-square
#' @param n1 sample size
#' @param sigma1 standard deviation
#' @param mean1 mean
#' @param iter number of iterations
#' @param ymax maximum value of y axis
#' @param ... other argumenets passed to specific methods
#'
#' @return A plot of theoretical and simulated curves over a barplot
#' @export
#'
#' @examples mychisim(10,4,10,1000)
mychisim<-function(n1=10,sigma1=3,mean1=5,iter=1000,ymax=0.1,...){    # adjust ymax to make graph fit
  ...
  legend(0.05,0.05,c("Simulated","Theoretical"),col=c("Blue","Red"),lwd=4,lty=1:2,bty="n",title=title) # Legend #
