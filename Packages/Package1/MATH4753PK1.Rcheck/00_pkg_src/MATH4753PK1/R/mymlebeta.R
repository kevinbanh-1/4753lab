#' Maximum Likelihood Estimate of a Beta Distribution
#'
#'
#' @description Function that takes in a vector and x, y parameters and creates a contour plot of the maximum likelihood estimates
#' @usage mymlbeta(x,alpha,beta,...)
#' @param x Sample vector
#' @param alpha x limit
#' @param beta y limit
#' @param ... other parameters passed to specific methods
#'
#' @return A contour plot of maximum likelihood estimates
#' @export
#'
#' @examples
